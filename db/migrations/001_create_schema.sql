...
CREATE INDEX IF NOT EXISTS idx_categories_house_id ON categories(house_id);
CREATE INDEX IF NOT EXISTS idx_posts_house_category_created_at ON posts(house_id, category_id, created_at DESC);
